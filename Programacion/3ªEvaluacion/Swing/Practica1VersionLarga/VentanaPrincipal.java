package Swing.Practica1VersionLarga;
...
public class VentanaPrincipal extends JFrame implements ActionListener {
	...
	private DefaultListModel modelo; // Objeto que modela la lista (adaptador)
	...
	public VentanaPrincipal() {
		...
		// crea la lista desde cero

		// IMPORTANTISIMO --> ahora cargamos desde fichero
		inicio();
		cargarDeArchivo();
...
// Establece la posición del campo de texto dirección
		...
		// Establece el botón Añadir persona Y GUARDAR
		añadir = new JButton();
		guardar = new JButton();
		;
		...
		guardar.setBounds(15, 150, 80, 23);
...
// Se añade cada componente gráfico al contenedor de la ventana
	...
	public void actionPerformed(ActionEvent evento) {
		...
		if (evento.getSource() == guardar) { /*
												 * Si se pulsa el botón GUALDAL lista
												 */
	...
	public void guardarLista() {
		// private ListaPersonas lista; // El objeto ListaPersonas de la aplicación
		lista.guardarEnArchivo("datos.obj");
	}

	/*
	// preparar
	public ArrayList<Persona> cargarLista() {
		return lista.cargarDesdeArchivo("datos.obj");
	}
	 */
	/**
...
// Se colocan todos los campos de texto nulos
	...
	private void cargarDeArchivo() {
		...
		borrarLista();
		for (Persona persona : this.lista.cargarDesdeArchivo("datos.obj")) {

			modelo.addElement(persona.getNombre() + "-" + persona.getApellidos() + "-" + persona.getTelefono() + "-"
					+ persona.getDireccion()); /* Se agrega el texto con los datos de la persona al JList */
			listaNombres.setModel(modelo);
		}
